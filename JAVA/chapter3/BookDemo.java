...
class BookDemo
{
	...
	void showBooks()
	{
		...
		stores the number of items in an array */			System.out.println("Book Title \t\t\t Price");
		System.out.println("============= \t\t\t ======");
	...
	{
		/* create an object of BookDemo class and invoke createBooks 
	           and showBooks methods using the object */
